...
public class ContratoLocacaoRequest {
    @NotNull
    ...
    public Long getLocadorPessoaId() { return locadorPessoaId; }
    public void setLocadorPessoaId(Long locadorPessoaId) { this.locadorPessoaId = locadorPessoaId; }
    public Long getInquilinoPessoaId() { return inquilinoPessoaId; }
    public void setInquilinoPessoaId(Long inquilinoPessoaId) { this.inquilinoPessoaId = inquilinoPessoaId; }
