...
SET @ddl := IF(@col = 0,
    'ALTER TABLE acerto_cliente_config ADD COLUMN data_ultimo_acerto_conhecido DATE NULL COMMENT ''Último acerto conhecido (corte manual): lançamentos até esta data formam bloco FECHADO_MANUAL''',
    'DO 0');
