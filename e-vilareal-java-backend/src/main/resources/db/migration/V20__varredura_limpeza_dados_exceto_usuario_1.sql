-- Nova varredura (idempotente): mesmo escopo de V19 — zera dados operacionais exceto usuario id=1 e pessoa id=1.
-- Preserva perfis, admin e plano de contas padrão; reinicia tópicos padrão.
