-- Remove 100% das linhas de cadastro de pessoas (e usuários do sistema).
-- Em seguida recria apenas pessoa id=1 + usuario id=1 + usuario_perfil (1,1) como no V2 (login admin / senha password).
-- Zera também dados operacionais que referenciam pessoa/processo/usuário e restaura plano de contas + tópicos padrão.
