-- Zera dados operacionais no banco, exceto usuario id=1 e pessoa id=1 (bootstrap V2).
-- Preserva tabela perfil e o vínculo usuario_perfil do admin (1,1) após remoção dos demais usuários.
-- Redefine plano de contas ao padrão V11 (como V16) e hierarquia de tópicos ao padrão V7 (como V14).
