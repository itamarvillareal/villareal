 ...
 * Não remove «Â» isolado (ex.: CÂMARA permanece válido).
 */
...
/** Substituições planilha — sem remover «Â» isolado (preserva CÂMARA, etc.). */
...
export function corrigirMojibakeUtf8(s) {
  ...
  // Ex.: GONÃ§ALVES → GONçALVES → GONÇALVES (sobrenome em maiúsculas)
