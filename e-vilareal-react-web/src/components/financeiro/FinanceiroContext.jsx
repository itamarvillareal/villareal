...
export function FinanceiroProvider({
  ...
  const filtersValue = useMemo(
    () => ({
      ...
      setBancos: extratoFilters.setBancos,
      setCartaoFiltro: extratoFilters.setCartaoFiltro,
      ...
      setValorFiltro: extratoFilters.setValorFiltro,
    ...
    [
      ...
      extratoFilters.setBancos,
      extratoFilters.setCartaoFiltro,
