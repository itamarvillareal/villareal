...
const MENU_ICONS = {
  ...
  'processos/distribuicao-inicial-projudi': Scale,
  ...
  'imoveis/conciliacao': IconConciliacao,
  'imoveis/relatorios': IconSpreadsheet,
  iptu: IconIptuMenu,
  'imoveis/relatorio-financeiro': IconFinanceiro,
  'relatorio-imoveis': IconSpreadsheet,
  'documentos/gerar': IconGerarDocumento,
  'conferencia-contratos-honorarios': ClipboardCheck,
  agenda: IconAgenda,
  ...
  'financeiro-grupo': IconFinanceiro,
  'resultado-financeiro': CircleDollarSign,
  ...
  'whatsapp/aniversarios': Cake,
  'whatsapp/cobrancas': Banknote,
