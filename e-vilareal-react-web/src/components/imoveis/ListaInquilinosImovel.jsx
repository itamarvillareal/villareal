 ...
 * }} props
 */
export function ListaInquilinosImovel({ inquilinos, onChange, onPersistir, onAbrirCadastroPessoa, disabled = false }) {
                  ...
                  return (
                    <p
                      className={`text-sm font-semibold text-slate-900 dark:text-slate-50 truncate ${
                        podeAbrir ? 'cursor-pointer rounded px-0.5 -mx-0.5 hover:bg-teal-100/50 dark:hover:bg-teal-900/20' : ''
                      }`}
