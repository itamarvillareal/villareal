    ...
    if (error) {
      return (
        <div className="flex min-h-[12rem] flex-col items-center justify-center gap-3 p-8 text-center">
          <p className="text-base font-semibold text-red-700">Não foi possível abrir o processo</p>
          <p className="max-w-md text-sm text-slate-600 leading-relaxed">
            {String(error?.message || error || 'Erro inesperado ao carregar o formulário.')}
          </p>
          <button
            type="button"
