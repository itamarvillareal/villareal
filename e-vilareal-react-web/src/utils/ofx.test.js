...
<STMTTRN><TRNTYPE>CREDIT</TRNTYPE><DTPOSTED>20260616120000</DTPOSTED><TRNAMT>38.97</TRNAMT><FITID>0</FITID><CHECKNUM>0</CHECKNUM><MEMO>CR LV OR E</MEMO></STMTTRN>
  ...
  it('CEF: valor com ponto de milhar E decimal (-4.856.61) não vira 0', () => {
    const text = `<OFX><BANKMSGSRSV1><STMTTRNRS><STMTRS><BANKTRANLIST>
<STMTTRN><TRNTYPE>DEBIT</TRNTYPE><DTPOSTED>2026072000[-3:BRT]</DTPOSTED><TRNAMT>-4.856.61</TRNAMT><FITID>201752</FITID><MEMO>PIX ENVIADO</MEMO></STMTTRN>
<STMTTRN><TRNTYPE>DEBIT</TRNTYPE><DTPOSTED>2026070800[-3:BRT]</DTPOSTED><TRNAMT>-16.658.01</TRNAMT><FITID>081959</FITID><MEMO>PIX ENVIADO</MEMO></STMTTRN>
<STMTTRN><TRNTYPE>CREDIT</TRNTYPE><DTPOSTED>2026072000[-3:BRT]</DTPOSTED><TRNAMT>834.91</TRNAMT><FITID>202340</FITID><MEMO>DEVOLUCAO PIX RECEBIDO</MEMO></STMTTRN>
<STMTTRN><TRNTYPE>CREDIT</TRNTYPE><DTPOSTED>2026070100[-3:BRT]</DTPOSTED><TRNAMT>1.234,56</TRNAMT><FITID>999</FITID><MEMO>CRED TED</MEMO></STMTTRN>
</BANKTRANLIST></STMTRS></STMTTRNRS></BANKMSGSRSV1></OFX>`;
    const rows = parseOfxToExtrato(text);
    const porNumero = Object.fromEntries(rows.map((r) => [r.numero, r.valor]));
    expect(porNumero['201752']).toBe(-4856.61);
    expect(porNumero['081959']).toBe(-16658.01);
    expect(porNumero['202340']).toBe(834.91);
    expect(porNumero['999']).toBe(1234.56);
  });
